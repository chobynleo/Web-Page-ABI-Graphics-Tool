<template>
    <div class="home" >
        <div class="nav">
            <button type="button" class="el-button el-button--primary" @click="dialogFormVisible = true"
             style="margin-bottom: 10px;margin-left: 45px;">
                <span>
                    添加合约
                </span>
            </button>
        ...
        <div class="contract-list">
            <el-container style="height: 800px; border: 1px solid #eee">
                ...
                <el-container>
                    ...
                    <button type="button" class="el-button el-button--danger" @click="deleteContract"
                    ...
                    <el-table :data="tableData" >
                        ...
                        <el-table-column prop="ItemNetwork" label="链条网络">
                        </el-table-column>
                        <el-table-column prop="ItemAddress" label="合约地址">
                        </el-table-column>
                    </el-table>
                    <div class="sol-body">
                        <div class="sol-body-left">
                            <el-aside width="400px" style="height:800px;border-color:rgb(235 238 245);border-style:dashed;">
                                <el-menu :data="tableData">
                                    <div v-if="tableData[0].ItemAbi != null">
                                        <el-submenu v-for="(item, index) in tableData[0].ItemAbi" :key="index" :index="index + ''">
                                            <template slot="title">
                                                ...
                                                <el-tag v-if="!item.stateMutability" type="warning" > nonpayable </el-tag>
                                                <span style="margin-left:30px">{{item.name}}</span>
                                            </template>
                                            <el-menu-item>
                                                <el-form :model="abiForm" :rules="rules" :ref="index + 'form'">
                                                    <div>
                                                        <div v-for="(item_input, _index) in item.inputs" :key="_index"
                                                            :index="_index + 'input'">
                                                            <input class="abi-input" autocomplete="off"
                                                            :name="_index + 'input'"
                                                            :placeholder="item_input.type"/>
                                                        </div>
                                                        <div style="text-align:center">
                                                            <el-button type="primary"
                                                            @click="submitAbiForm(item, index)">运行</el-button>
                                                        </div>
                                                    </div>
                                                </el-form>
                                            </el-menu-item>
                        ...
                        <div class="sol-body-right" :data="abiCardData">
                            <div v-if="abiCardData.length != 0">
                                ...
                                :key="index" :index="index + 'card'" style="width:700px">
    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                network: [
                    { validator: checkNetwork, trigger: 'blur' },
                ],
            },
            // 表单子栏的宽度
